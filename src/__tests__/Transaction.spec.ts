...
import Character from '../models/Transaction';
import Class from '../models/Category';
...
describe('Transaction', () => {
	...
	it('should be able to create new transaction', async () => {
		const transactionsRepository = getRepository(Character);
	...
	it('should create tags when inserting new transactions', async () => {
		const transactionsRepository = getRepository(Character);
		const categoriesRepository = getRepository(Class);
